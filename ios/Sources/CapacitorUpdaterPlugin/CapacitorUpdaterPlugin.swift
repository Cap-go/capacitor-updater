...
public class CapacitorUpdaterPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    override public func load() {
        ...
        implementation.statsMode = CapgoUpdater.normalizeStatsMode(
        ...
        implementation.setStatsMode(
            CapgoUpdater.normalizeStatsMode(getConfig().getString("statsMode", CapgoUpdater.statsModeAll))
        )
