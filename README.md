...
| **`shakeMenu`**                 | <code>boolean</code>                                                                                       | Enable the shake gesture while a preview session is active. Outside preview sessions, shaking the device is ignored.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | <code>false</code>                                                            | 7.5.0   |
| **`allowShakeChannelSelector`** | <code>boolean</code>                                                                                       | Keep the shake channel selector preference for compatibility. The native shake gesture is ignored outside preview sessions, and preview sessions always use the preview reload/leave menu. Only available for Android and iOS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | <code>false</code>                                                            | 8.43.0  |
