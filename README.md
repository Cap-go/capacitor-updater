...
| **`allowPreview`**              | <code>boolean</code>                                          | Allow JavaScript to start a native preview session and request previews for another app id. This is intended for trusted container apps that implement Expo Go-style preview flows. Only available for Android and iOS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | <code>false</code>                                                            | 8.47.0  |
...
| **`appId`**   | <code>string</code>  | App id to request updates for while using a trusted preview container. Requires {@link PluginsConfig.CapacitorUpdater.allowPreview} to be `true`. | <code>undefined</code> | 8.47.0 |
| **`preview`** | <code>boolean</code> | Mark the update check as a preview request. Requires {@link PluginsConfig.CapacitorUpdater.allowPreview} to be `true`.                            | <code>false</code>     | 8.47.0 |
