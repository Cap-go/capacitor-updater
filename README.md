...
```json
{
  "plugins": {
    "CapacitorUpdater": {
      ...
      "disableNonUpdateEvents": undefined,
      "limitUpdateEventsToBilling": undefined,
      "publicKey": undefined,
      "version": undefined,
