...
public class CapacitorUpdaterPlugin extends Plugin {
  ...
  private final String PLUGIN_VERSION = "5.6.12";
  ...
  public void load() {
    ...
    try {
      ...
      this.implementation.manifestStorage = ManifestStorage.init(this.getContext().getAssets(), this.editor, prefs, this.getContext().getFilesDir());
