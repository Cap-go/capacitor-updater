...
function runDocgen() {
  ...
  try {
    execFileSync(
      DOCGEN_BIN,
      ['--api', 'CapacitorUpdaterPlugin', '--output-readme', README, '--output-json', DOCS_JSON],
      { stdio: 'inherit' },
    );
    ...
    execFileSync('docgen', ['--api', 'CapacitorUpdaterPlugin', '--output-readme', README, '--output-json', DOCS_JSON], {
      stdio: 'inherit',
    });
